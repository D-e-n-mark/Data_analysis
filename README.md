...
| ------ | ------ | ------ |
| [Музыка больших городов]([https://practicum.yandex.ru/data-analyst/](https://github.com/D-e-n-mark/Practicum/tree/main/1.%20big%20city%20music) ) | Сравнение Москвы и Санкт-Петербурга по музыкальным предпочтнениям на основе собранных данных | ``Python`` ``Pandas``
